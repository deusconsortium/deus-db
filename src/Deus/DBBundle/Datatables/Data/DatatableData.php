...
use Sg\DatatablesBundle\Datatable\Data\DatatableDataInterface;
...
class DatatableData implements DatatableDataInterface
{
    ...
    public function getResponse()
    {
        ...
        $output = array("data" => array(), "filters" => array());
        ...
        foreach ($this->searchColumns as $id => $item) {
            $output["filters"][$id] = $this->datatableQuery->getFilterValues($id);
        }
